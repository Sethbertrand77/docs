...
`),J,n(`
`),X,n(`
`),s("span",L,[s("span",Z,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),Y,n(`
...
`),s("span",Xs,[s("span",Ls,"  rest: '"+l(a.constants.arabicaRestUrl)+"'",1)]),n(`
`),Zs,n(`
`),Ys,n(`
