...
`),L,n(`
`),z,n(`
`),s("span",J,[s("span",X,"  chainId: '"+l(a.constants.mainnetChainId)+"',",1)]),n(`
`),Z,n(`
`),s("span",Q,[s("span",W,"  rpc: '"+l(a.constants.mainnetRpcUrl)+"',",1)]),n(`
